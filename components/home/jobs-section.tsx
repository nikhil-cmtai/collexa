    ...
    <div className="max-w-7xl mx-auto mb-16">
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden rounded-2xl md:rounded-3xl py-8 md:py-12">
          ...
          >
            {currentCards.map((item: JobItem, index: number) => (
              <motion.div 
                key={`${item.id}-${index}`} 
              ...
              >
                ...
                >
                  <div className="relative bg-gradient-to-br from-blue-50/30 via-white to-purple-50/30 rounded-xl md:rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-blue-100">
                    ...
                    <div className="p-3 md:p-5">
                      ...
                      {/* Divider */}
                      <div className="h-px bg-gradient-to-r from-transparent via-blue-200 to-transparent mb-2 md:mb-3"></div>

                      {/* Location */}
                      <div className="flex items-center gap-1 md:gap-1.5 mb-2 md:mb-2.5">
                        <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center justify-between pt-2 md:pt-3 border-t border-blue-100">
                        <span className="px-2 md:px-2.5 py-0.5 md:py-1 bg-blue-50 text-blue-700 text-[10px] md:text-xs font-medium rounded-md md:rounded-lg border border-blue-200">
                          {item.type}
                        </span>
                        <button className="text-blue-600 text-xs md:text-sm font-semibold hover:text-blue-700 flex items-center gap-0.5 md:gap-1 transition-colors">
                          View details
